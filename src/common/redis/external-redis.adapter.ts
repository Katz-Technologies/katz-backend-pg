...
@Injectable()
export class ExternalRedisAdapter implements RedisService, OnModuleDestroy {
  ...
  // Делегируем все методы Redis клиенту
  ...
  // Делегируем методы RedisService, которые требуются интерфейсом
