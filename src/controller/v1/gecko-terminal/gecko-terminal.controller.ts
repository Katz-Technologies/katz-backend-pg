...
import { GeckoTerminalService } from 'src/integrations/gecko-terminal/gecko-terminal.service';
...
export class GeckoTerminalController {
  ...
  @Get('last-24h-volume')
  async getLast24hVolume(@Query() asset: GetLast24hVolumeDto): Promise<number> {
