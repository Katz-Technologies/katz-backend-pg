...
import { ClickhouseService } from 'src/common/clickhouse/clickhouse.service';
...
export class CronService implements OnModuleInit {
  ...
  @Cron(CronExpression.EVERY_HOUR)
  async handleFallbackIconRefreshCron() {
    this.logger.log(
